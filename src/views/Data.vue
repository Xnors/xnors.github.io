...
export default {
    ...
    methods: {
        async getWebData() {
            try {
                const response = await fetch('https://xnors.pythonanywhere.com/get_web_data'); //https://xnors.pythonanywhere.com/get_web_data
        ...
        async addVisitCount() {
            try {
                // POST 请求
                const response = await fetch('https://xnors.pythonanywhere.com/web_data_add1', {
                    method: 'POST',
                    headers: {
